...
После полного технического прохождения и release verification записать `retrospective.md`: удобство подготовки, расхождения графа и игры, ручные решения, работа NPC, эффект глобальных выборов, восстановление, недостающие данные и изменения скиллов. Будущий авторский стол может дополнять ретроспективу, но не подменяет обязательный технический прогон. Без ретроспективы этап 2 не завершён.
