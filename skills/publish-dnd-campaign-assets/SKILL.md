...
5. Добавить запись в `assets/concepts/manifest.json` со связанной сущностью и назначением.
6. Проверить уникальность `id`, существование файла и отсутствие ссылок на отклонённые версии.
